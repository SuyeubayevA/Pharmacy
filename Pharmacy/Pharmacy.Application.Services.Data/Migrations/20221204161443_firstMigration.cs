        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Properties = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductReminder = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInfos_Id",
                table: "SalesInfos",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SalesInfos_ProductId",
                table: "SalesInfos",
                column: "ProductId",
                unique: true);
